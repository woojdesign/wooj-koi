  ...
  const sketch = (p) => {
    ...
    p.draw = function () {
      ...
      for (const boid of flock.boids) {
        ...
        // Wave amplitude tracks speed (v0.1.9): a gliding fish undulates gently, a darting one
        // whips harder — so the body visibly swells on each gait burst. Reads dynamic-but-calm.
